import { Flex, Grid, GridItem, Text, Heading, Box } from "@chakra-ui/react";
...
const Hero = () => {
  return (
    <Box className="hero" bg="bg.container2" h={"calc(100vh - 80px)"}>
      <Grid
      ...
      >
        <GridItem pb="12.4rem" pt="32">
          ...
          <Text fontSize="16" fontWeight="regular" color="font.hero">
            <span style={{ fontWeight: "500" }}>Need counseling?</span> Click
            the button to get your counseling scheduled.
          </Text>
        </GridItem>
